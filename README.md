...
A lightweight, standalone HTML & JavaScript application that replicates common Excel automation tasks directly in the browser, with no installation needed.
